...
public class RestResult<T> implements Serializable{
	...
	public static <T> RestResult<T> unAuthorized(String msg) {
		...
		if(StringUtils.isBlank(msg)) {
			return new RestResult<T>(ResultCode.UNAUTHORIZED, "认证失败,请登录!",null);
		}
		return new RestResult<T>(ResultCode.UNAUTHORIZED, msg,null);
	}
	...
	public enum ResultCode {
		...
		private ResultCode(int code, String msg,boolean success) {
			this.code = code;
			this.msg = msg;
			this.success = success;
		}
